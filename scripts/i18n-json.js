...
const enDashboard = {
  ...
  demoModeDesc:
    "This data is prepared for sample usage. You can turn off demo mode to see the real user experience.",
  ...
  correct: "correct",
  read: "Read",
  recentActivitiesEmptyDesc:
    "See your activities and track your progress by taking tests or studying topics!",
...
const trDashboard = {
  ...
  demoModeDesc:
    "Bu veriler örnek kullanım için hazırlanmış demo verileridir. Gerçek kullanım deneyimini görmek için demo modunu kapatabilirsiniz.",
